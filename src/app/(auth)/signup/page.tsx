      ...
      <div className="w-full max-w-md p-8 space-y-8 rounded-lg dark:bg-neutral-900 bg-white border shadow-md">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl mb-6">
            Try Anonymous Feedback
          </h1>
          <p className="mb-4 text-neutral-300">Sign up to start your anonymous adventure</p>
        </div>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  {usernameMessage && (
                    <FormDescription className={`${!isUsernameUnique && 'text-red-500'}`}>{usernameMessage}</FormDescription>
                  )}
                  <FormMessage />
                </FormItem>
              )}
        ...
        <div className="text-center mt-4">
          <p className="text-xs text-neutral-400">
            Already a member? <Link href="/signin" className="text-neutral-300 underline">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
